...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create would-you-rather-8b4c
  fly apps create would-you-rather-8b4c-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app would-you-rather-8b4c
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app would-you-rather-8b4c-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'would-you-rather-8b4c-staging' does not match app name in config file 'would-you-rather-8b4c'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name would-you-rather-8b4c-db
  fly postgres attach --app would-you-rather-8b4c would-you-rather-8b4c-db

  fly postgres create --name would-you-rather-8b4c-staging-db
  fly postgres attach --app would-you-rather-8b4c-staging would-you-rather-8b4c-staging-db
  ```
